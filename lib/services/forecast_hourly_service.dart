...
class ForecastHourlyService {
  ...
  Future<ForecastHourlyData> getWeather() async {
    try {
      ...
      final String apiUrl = 'https://pro.openweathermap.org/data/2.5/forecast/hourly?lat=${position.latitude}&lon=${position.longitude}&appid=${WEATHER_API_KEY}&units=metric';
