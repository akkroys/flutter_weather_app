...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "internet_connection_error": MessageLookupByLibrary.simpleMessage(
            "Отсутствует соединение с интернетом. Последнее обновление:"),
        ...
        "location_permission_denied": MessageLookupByLibrary.simpleMessage(
            "Доступ к геолокации был запрещен"),
        "location_permission_denied_content":
            MessageLookupByLibrary.simpleMessage(
                "Для работы приложения разрешите доступ в настройках"),
